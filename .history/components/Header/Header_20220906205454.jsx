      ...
      <div className={styles["section__text-container"]}>
        <div className={styles["section__text-container-content"]}>
          <div className={styles["section__text-container-content-row"]}>
            <span className={styles["section__text-container-row-title"]}>SAMAHAN SysDev Code Camp For Dummies 2022</span> is the first ever online code camp hosted by the SAMAHAN System Development committee. This event is centered on web development — the SysDev way. 
            </div>
            <div className={styles["section__text-container-content-row"]}>
