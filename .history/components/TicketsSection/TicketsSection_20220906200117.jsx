  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.row}>
          <Card color="nextstorybook" date="D-3: OCT 1, 2022" day="Saturday" dev_type="<FRONT-END />" main_topic="intro to nextjs + storybook" link="https://fonts.google.com/knowledge" />
          <Card color="expressgithub" date="D-4: OCT 7, 2022" day="Friday" dev_type="<BACK-END />" main_topic="Restful expressjs github desktop crash course" link="https://fonts.google.com/knowledge" />
        </div>
      </div>
    </div>
  )
