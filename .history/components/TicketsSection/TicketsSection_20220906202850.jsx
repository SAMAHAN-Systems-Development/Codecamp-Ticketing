    ...
    <div className={styles["section"]}>
      ...
      <div className={styles["section__content"]}>
        <div className={styles["section__content-row"]}>
          ...
          <Card type="htmlsass" date="D-2: SEP. 30, 2022" day="Friday" dev_type="<FRONT-END />" main_topic="HTML & Sass {\n} Intro to Javascript-React" link="https://fonts.google.com/knowledge" />
        </div>
        <div className={styles["section__content-row"]}>
